...
<body class="nk-body bg-white npc-general pg-error">
				...
				<div class="nk-content ">
					<div class="nk-block nk-block-middle wide-xs mx-auto">
						<div class="nk-block-content nk-error-ld text-center"><h1 class="nk-error-head">404</h1>
							...
							<a href="/" class="btn btn-lg btn-primary mt-2">Back To Home</a></div>
					</div>
				</div>
			</div>
		</div>
	...
	<ul class="nk-sticky-toolbar">
		<li class="demo-thumb"><a class="toggle" data-target="demoPanel" href="#"><em class="icon ni ni-dashlite"></em></a>
		</li>
		<li class="demo-settings">
			<a class="toggle" data-target="settingPanel" href="#"><em class="icon ni ni-setting-alt"></em></a></li>
		<li class="demo-purchase">
			<a target="_blank" href="https://1.envato.market/e0y3g"><em class="icon ni ni-cart"></em></a></li>
	</ul>
	<div class="nk-demo-panel toggle-slide toggle-slide-right" data-content="demoPanel" data-toggle-overlay="true" data-toggle-body="true" data-toggle-screen="any">
		<div class="nk-demo-head"><h6 class="mb-0">Switch Dashboard</h6>
			<a class="nk-demo-close toggle btn btn-icon btn-trigger revarse mr-n2" data-target="demoPanel" href="#"><em class="icon ni ni-cross"></em></a>
		</div>
		<div class="nk-demo-list" data-simplebar>
			<div class="nk-demo-item"><a href="/">
					<div class="nk-demo-image bg-purple">
						<img class="bg-purple" src="/images/landing/gd-default.jpg" srcset="/images/landing/gd-default2x.jpg 2x" alt="General Dashboard">
					</div>
					<span class="nk-demo-title">Apps - SAAS / Subscription</span></a></div>
			<div class="nk-demo-item"><a href="/crypto/index.html">
					<div class="nk-demo-image bg-warning">
						<img src="/images/landing/demo-buysell.jpg" srcset="/images/landing/demo-buysell2x.jpg 2x" alt="Crypto BuySell / Wallet">
					</div>
					<span class="nk-demo-title">Apps - Crypto BuySell / Wallet</span></a></div>
			<div class="nk-demo-item"><a href="/invest/index.html">
					<div class="nk-demo-image bg-indigo">
						<img src="/images/landing/demo-invest.jpg" srcset="/images/landing/demo-invest2x.jpg 2x" alt="HYIP / Investment">
					</div>
					<span class="nk-demo-title">Apps - HYIP / Investment</span></a></div>
			<div class="nk-demo-item"><a href="/apps/messages/index.html">
					<div class="nk-demo-image bg-success">
						<img src="/images/landing/demo-messages.jpg" srcset="/images/landing/demo-messages2x.jpg 2x" alt="Messages">
					</div>
					<span class="nk-demo-title">Apps - Messages
						<div class="badge badge-info badge-dim ml-1">v1.1</div>
					</span></a></div>
			<div class="nk-demo-item"><a href="/apps/inbox/index.html">
					<div class="nk-demo-image bg-purple">
						<img src="/images/landing/demo-inbox.jpg" srcset="/images/landing/demo-inbox2x.jpg 2x" alt="Inbox">
					</div>
					<span class="nk-demo-title">Apps - Inbox
						<div class="badge badge-info badge-dim ml-1">v1.3</div>
					</span></a></div>
			<div class="nk-demo-item nk-demo-note"><h6 class="overline-title text-danger">Price Change Notice:</h6>
				<p>Our regular price will be <strong>35$</strong> from last week of March 2020.</p></div>
		</div>
	</div>
	<div class="nk-demo-panel toggle-slide toggle-slide-right" data-content="settingPanel" data-toggle-overlay="true" data-toggle-body="true" data-toggle-screen="any">
		<div class="nk-demo-head"><h6 class="mb-0">Preview Settings</h6>
		...
		<div class="nk-opt-panel" data-simplebar>
			<div class="nk-opt-set">
				...
				<div class="nk-opt-list col-2x">
					<div class="nk-opt-item only-text active" data-key="style" data-update="ui-default">
						<span class="nk-opt-item-bg"><span class="nk-opt-item-name">Default</span></span></div>
					<div class="nk-opt-item only-text" data-key="style" data-update="ui-clean">
						<span class="nk-opt-item-bg"><span class="nk-opt-item-name">Clean</span></span></div>
					<div class="nk-opt-item only-text" data-key="style" data-update="ui-shady">
						<span class="nk-opt-item-bg"><span class="nk-opt-item-name">Shady</span></span></div>
					<div class="nk-opt-item only-text" data-key="style" data-update="ui-softy">
						<span class="nk-opt-item-bg"><span class="nk-opt-item-name">Softy</span></span></div>
				</div>
			</div>
			<div class="nk-opt-set nk-opt-set-aside-apps">
				...
				<div class="nk-opt-list col-4x">
					...
					<div class="nk-opt-item active" data-key="appside" data-update="is-dark">
						<span class="nk-opt-item-bg"><span class="bg-dark"></span></span><span class="nk-opt-item-name">Dark</span>
					</div>
					<div class="nk-opt-item" data-key="appside" data-update="is-theme">
			...
			<div class="nk-opt-set nk-opt-set-aside">
				...
				<div class="nk-opt-list col-4x">
					...
					<div class="nk-opt-item active" data-key="aside" data-update="is-dark"><span class="nk-opt-item-bg"><span class="bg-dark"></span></span><span class="nk-opt-item-name">Dark</span>
					</div>
			...
			<div class="nk-opt-set nk-opt-set-skin">
				...
				<div class="nk-opt-list">
					...
					<div class="nk-opt-item" data-key="skin" data-update="purple">
						<span class="nk-opt-item-bg"><span class="skin-purple"></span></span><span class="nk-opt-item-name">Purple</span>
					</div>
			...
			<div class="nk-opt-set">
				...
				<div class="nk-opt-list col-2x">
					<div class="nk-opt-item active" data-key="mode" data-update="theme-light">
						<span class="nk-opt-item-bg is-light"><span class="theme-light"></span></span><span class="nk-opt-item-name">Light Skin</span>
					</div>
					<div class="nk-opt-item disabled" data-key="mode" data-update="theme-dark">
						<span class="nk-opt-item-bg"><span class="theme-dark"></span></span><span class="nk-opt-item-name">Dark Skin
							<small>(Soon)</small></span></div>
				</div>
			</div>
