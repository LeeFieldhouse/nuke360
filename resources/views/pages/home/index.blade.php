								...
								<div class="row g-gs">
									<div class="col-lg-6 col-xxl-12">
										<div class="card card-bordered" style="height: 100%;">
											<iframe style="width: 100%; height: 100%;" src="https://www.youtube.com/embed/ZzO_f2wJlMA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
										</div>
									</div><!-- .col -->
									<div class="col-lg-6 col-xxl-12">
										<div class="card card-bordered">
											<div class="card-inner">
												...
												<script>
													hbspt.forms.create({
														portalId: "7348542",
														formId: "d5192b61-5d61-44aa-b2a1-bece195408e3"
													});
												</script>
											</div>
										</div>
